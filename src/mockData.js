...
mockCities = [
    ...
    { id: 'olympia', name: 'Olympia', stateLong: 'Washington', state: 'WA', coordinates: [-122.9007, 47.0379] },
    { id: 'oakland', name: 'Oakland', stateLong: 'California', state: 'CA', coordinates: [-122.2711, 37.8044] },
    { id: 'san-jose', name: 'San Jose', stateLong: 'California', state: 'CA', coordinates: [-121.8863, 37.3382] },
    { id: 'eugene', name: 'Eugene', stateLong: 'Oregon', state: 'OR', coordinates: [-123.0868, 44.0521] },
